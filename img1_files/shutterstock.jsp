			...
			try {
				...
				if (!usi_app.suppress_page) {
					...
					if ((usi_app.get_user_status("user").status == "guest" || usi_app.get_user_status("user").isActive == "false") && ((/.shutterstock.com\/image-generated|.shutterstock.com\/ai-image-generator|.shutterstock.com\/generate|.shutterstock.com\/search\?image_type=generated/i).test(location.href) || checkout_ai_eligible) && (language_key == "_english")) {
						...
						if(!usi_commons.gup_or_get_cookie('usi_ai_test') && usi_date.is_between('2023-11-13','2023-11-20T23:59:00-08:00')) {
							usi_app.messaging = usi_app.get_messaging('sitewide_event_2023_bfcm');
							usi_commons.log("[USI] 49287 Sitewide Event 20% Off [IMAGES] :: " + usi_commons.device + language_key)
							return usi_commons.load_view("G5HkOzAU1SjWZz1kFgCOAcz", "49287", usi_commons.device + language_key);
						}
						else if(!usi_commons.gup_or_get_cookie('usi_ai_test') && usi_date.is_between('2023-11-21','2023-12-13T23:59:00-08:00')) {
							var messaging = "", param1 = "", param2 = "";

							messaging = "generic_tenpercent";
							if (usi_app.is_cart_page || usi_app.is_checkout_page) param1 = "TgStatxuQ584ZAAsEiEvLgr", param2 = "48217";
							...
							if (usi_app.messaging && usi_app.messaging.header1) {
								return usi_commons.load_view(param1, param2, usi_commons.device + language_key);
							}
						}
						else {
					...
					if (usi_app.is_image_page || usi_app.is_image_in_cart) {
						var threshold = 0;
						if (!usi_date.is_between('2023-11-13','2023-12-13T23:59:00-08:00') && usi_app.check_sub_total_price(threshold) && (usi_app.is_flexable || (usi_app.is_checkout_page && checkout != null && (checkout.textContent.trim().indexOf("FLEX 10") != -1 || checkout.textContent.trim().indexOf("5 Credit Pack") != -1 || checkout.textContent.trim().indexOf("2 Credit Pack") != -1)))) {
							...
							if(usi_date.is_between('2023-11-05','2023-11-20T23:59:00-08:00')) {
									usi_app.messaging = usi_app.get_messaging('sitewide_event_2023_bfcm');
									usi_commons.log("[USI] 49287 Sitewide Event 20% Off [IMAGES] :: " + usi_commons.device + language_key)
									usi_commons.load_view("G5HkOzAU1SjWZz1kFgCOAcz", "49287", usi_commons.device + language_key);
							} else {
								//CF
								var messaging = "", param1 = "", param2 = "";
								messaging = "generic_tenpercent";
						...
						if(usi_date.is_between('2023-11-05','2023-11-20T23:59:00-08:00')) {
							usi_app.messaging = usi_app.get_messaging('sitewide_event_2023_bfcm');
							usi_commons.log("[USI] 49291 Sitewide Event 20% Off [VIDEOS] :: " + usi_commons.device + language_key)
							usi_commons.load_view("3hNz55AEFgQtuYlEcBIpqDl", "49291", usi_commons.device + language_key);
						} else {
						...
						if (!usi_date.is_between('2023-11-13','2023-12-13T23:59:00-08:00') && usi_app.check_sub_total_price(threshold) && (usi_app.is_flexable || (usi_app.is_checkout_page && checkout != null && (checkout.textContent.trim().indexOf("FLEX 10") != -1 || checkout.textContent.trim().indexOf("5 Credit Pack") != -1 || checkout.textContent.trim().indexOf("2 Credit Pack") != -1)))) {
							...
							if(usi_date.is_between('2023-11-05','2023-11-20T23:59:00-08:00')) {
								usi_app.messaging = usi_app.get_messaging('sitewide_event_2023_bfcm');
								usi_commons.log("[USI] 49293 Sitewide Event 20% Off [MUSIC] :: " + usi_commons.device + language_key)
								usi_commons.load_view("AGa4wapzPBBFkNeq21dsT3d", "49293", usi_commons.device + language_key);
							} else {
								//CF
								var messaging = "", param1 = "", param2 = "";
								messaging = "generic_tenpercent";
								if (usi_app.is_cart_page || usi_app.is_checkout_page) param1 = "dB1tUUlF78SowefOuGNGRvN", param2 = "48195";
		...
		usi_app.scrape_order_summary = function() {
			try {
				...
				if(usi_app.is_checkout_page) {
					...
					if(order_data.join('|').indexOf('Subscription')) {
